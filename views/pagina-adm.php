...
<body>
            ...
            <section class="section-content-adm col-sm-10 col-lg-10">
                <div class="div-table-adm table-wrapper-scroll-y my-custom-scrollbar">
                    ...
                    <caption><strong> LISTA DE USUÁRIOS</strong></caption>
                        ...
                        <tbody>
                        <?php     
                            $usuario_json = file_get_contents("http://localhost/morada-mais/models/buscaDadosBanco.php?table=usuario");
                            ...
                            if ($usuarios != []):
                                foreach($usuarios as $usuario): ?> 
                                    <tr> 
                                        ...
                                        <td><?= date("d/m/Y", strtotime($usuario['data_cadast'])); ?></td>
                                        <td><img src="<?= $usuario['img']; ?>" style="width: 60px" alt=""></td>
                                        <td><a class="btn btn-info"  href="form-edita-usuario.php?id=<?= $usuario['id_user']; ?>">Editar</a></td>
                ...
                <div class="div-table-adm table-wrapper-scroll-y my-custom-scrollbar">
                    ...
                    <caption><strong> MENSAGEM DO USUÁRIO</strong></caption>
                        ...
                        <tbody>
                        <?php     
                            $mensagem_json = file_get_contents("http://localhost/morada-mais/models/buscaDadosBanco.php?table=mensagem");
                ...
                <div id="div-cadast-admin">
                    <form action="../models/cadastrarAdmin.php" method="post" class="form-cadas-admin">
                        <fieldset >
                    ...
                    <div class="div-table-adm2 table-wrapper-scroll-y my-custom-scrollbar table-bordered">
                        ...
                        <tbody>
                        <?php     
                            $admin_json = file_get_contents("http://localhost/morada-mais/models/buscaDadosBanco.php?table=admin");
    ...
    <script language="Javascript">
        function confirmacao(id) {
            ...
            if (resposta == true) {
                window.location.href = "../models/excluirUsuario.php?id="+id;
            }
        }
    </script>