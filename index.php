        ...
        <header >
            <div class="container">
                <div class="intro-text">
                    <div class="intro-lead-in">Se você se identifica como LGBTQIA+, está precisando de um lugar para morar mas o dinheiro está curto e quer dividir o aluguel com alguém, esse alguém pode ter o perfil que combine com o seu - conheça a MORADA+ </div>
                    <a href="form-login.php" class="btn btn-xl" id="btn-login">Login</a>
                    <a href="form-cadastro.php" class="btn btn-xl">Cadastrar</a>
                </div>
            </div>
        </header>
            ...
            <div class="container">
                ...
                <div class="row text-center">
                    <div class="col-md-4">
                        ...
                        <h4 class="service-heading">Dividir o Aluguel com alguém da comunidade LBTQIA+</h4>
